////************6050IIC******////
/*
 *6050得到三轴角度方法：X轴get_6050_Angle_x()  float型
 *                      Y轴get_6050_Angle_y()  float型
 *                      Z轴get_6050_Angle_z()  float型
 */
/*
***************************************************************************
**文件名：Mpu-6050.c
...
float get_6050_Angle_x()
{
    return mpu6050_Angle(2);
}
float get_6050_Angle_y()
{
    return  mpu6050_Angle(1);
}
float get_6050_Angle_z()
{
    return mpu6050_Angle(0);
}
